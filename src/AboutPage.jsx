...
const AboutPage = () => {
 ...
 <h1 style={styles.title}>About GovExamQuiz</h1>
      ...
      <ul style={styles.list}>
        ...
        <li style={styles.listItem}><strong>Performance Tracking:</strong> With our advanced performance tracking features, you can monitor your progress, identify areas for improvement, and fine-tune your preparation strategy.</li>
        <li style={styles.listItem}><strong>User-Friendly Interface:</strong> Our platform is designed with simplicity in mind, ensuring a smooth and hassle-free experience for users of all levels. Whether you're a beginner or an experienced candidate, you'll find GovExamQuiz easy to navigate and highly effective.</li>
      </ul>
